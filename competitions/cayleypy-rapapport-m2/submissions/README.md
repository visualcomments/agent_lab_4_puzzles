...
Submit to Kaggle (optional):
    ...
    python ../../pipeline_cli.py run --competition cayleypy-rapapport-m2 --output submissions/submission.csv --no-llm --submit --message baseline --kaggle-json /path/to/kaggle.json --submit-via api
